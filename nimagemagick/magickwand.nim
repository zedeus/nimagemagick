{.passL: gorge("MagickWand-config --libs").}
{.passC: gorge("MagickWand-config --cflags").}
...
type
  ...
  Image* = object
  ImageInfo* = object
  AffineMatrix* {.importc: "AffineMatrix", header: headerMagickWand, bycopy.} = object
    sx*: cdouble
    rx*: cdouble
    ry*: cdouble
    sy*: cdouble
    tx*: cdouble
    ty*: cdouble
  GeometryInfo* {.importc: "GeometryInfo", header: headerMagickWand, bycopy.} = object
    rho*: cdouble
    sigma*: cdouble
    xi*: cdouble
    psi*: cdouble
    chi*: cdouble
  OffsetInfo* {.importc: "OffsetInfo", header: headerMagickWand, bycopy.} = object
    x*: cint
    y*: cint
  PointInfo* {.importc: "PointInfo", header: headerMagickWand, bycopy.} = object
    x*: cdouble
    y*: cdouble
  RectangleInfo* {.importc: "RectangleInfo", header: headerMagickWand, bycopy.} = object
    width*: uint
    height*: uint
    x*: cint
    y*: cint
  PrimaryInfo* {.importc: "PrimaryInfo", header: headerMagickWand, bycopy.} = object
    x*: cdouble
    y*: cdouble
    z*: cdouble
  SegmentInfo* {.importc: "SegmentInfo", header: headerMagickWand, bycopy.} = object
    x1*: cdouble
    y1*: cdouble
    x2*: cdouble
    y2*: cdouble
  ChromaticityInfo* {.importc: "ChromaticityInfo", header: headerMagickWand, bycopy.} = object
    red_primary*: PrimaryInfo
    green_primary*: PrimaryInfo
    blue_primary*: PrimaryInfo
    white_point*: PrimaryInfo
  CustomStreamHandler* = proc(a1: ptr cuchar,a2: uint): cint {.nimcall.}
  CustomStreamSeeker* = proc(a1: MagickOffsetType,a2: cint): MagickOffsetType {.nimcall.}
  CustomStreamTeller* = proc(): MagickOffsetType {.nimcall.}
  CustomStreamInfo* = object
  PixelChannelMap* {.importc: "PixelChannelMap", header: headerMagickWand, bycopy.} = object
    channel*: PixelChannel
    traits*: PixelTrait
    offset*: cint
  PixelInfo* {.importc: "PixelInfo", header: headerMagickWand, bycopy.} = object
  ...
  PixelPacket* {.importc: "PixelPacket", header: headerMagickWand, bycopy.} = object
    red*: cuint
    green*: cuint
    blue*: cuint
    alpha*: cuint
  ...
  CacheView* = object
  StreamInfo* = object
  StreamHandler* = proc(a1: ptr Image,a3: uint): uint {.nimcall.}
  ...
  ColorInfo* {.importc: "ColorInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    name*: cstring
    ...
    signature*: uint
  ErrorInfo* {.importc: "ErrorInfo", header: headerMagickWand, bycopy.} = object
    mean_error_per_pixel*: cdouble
    normalized_mean_error*: cdouble
    normalized_maximum_error*: cdouble
  Ascii85Info* = object
  KernelInfo* {.importc: "KernelInfo", header: headerMagickWand, bycopy.} = object
    `type`*: KernelInfoType
    width*: uint
    height*: uint
    x*: cint
  ...
  LocaleInfo* {.importc: "LocaleInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    tag*: cstring
    message*: cstring
    stealth*: MagickBooleanType
    signature*: uint
  MagickProgressMonitor* = proc(a1: cstring,a2: MagickOffsetType,a3: MagickSizeType): MagickBooleanType {.nimcall.}
  StringInfo* {.importc: "StringInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    datum*: ptr cuchar
    length*: uint
    signature*: uint
  ...
  ResizeFilter* = object
  Timer* {.importc: "Timer", header: headerMagickWand, bycopy.} = object
    start*: cdouble
    stop*: cdouble
    total*: cdouble
  TimerInfo* {.importc: "TimerInfo", header: headerMagickWand, bycopy.} = object
    user*: Timer
    elapsed*: Timer
    state*: TimerState
    signature*: uint
  TypeInfo* {.importc: "TypeInfo", header: headerMagickWand, bycopy.} = object
    face*: uint
    path*: cstring
    name*: cstring
    description*: cstring
    ...
    stealth*: MagickBooleanType
    signature*: uint
  StopInfo* {.importc: "StopInfo", header: headerMagickWand, bycopy.} = object
    color*: PixelInfo
    offset*: cdouble
  GradientInfo* {.importc: "GradientInfo", header: headerMagickWand, bycopy.} = object
    `type`*: GradientType
    ...
    angle*: cdouble
    signature*: uint
  ElementReference* {.importc: "ElementReference", header: headerMagickWand, bycopy.} = object
    id*: cstring
    `type`*: ReferenceType
    ...
    signature*: uint
  DrawInfo* {.importc: "DrawInfo", header: headerMagickWand, bycopy.} = object
    primitive*: cstring
    geometry*: cstring
  ...
  PrimitiveInfo* {.importc: "PrimitiveInfo", header: headerMagickWand, bycopy.} = object
    point*: PointInfo
    coordinates*: uint
  ...
  TypeMetric* {.importc: "TypeMetric", header: headerMagickWand, bycopy.} = object
    ...
    bounds*: SegmentInfo
    origin*: PointInfo
  CoderInfo* {.importc: "CoderInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    magick*: cstring
    name*: cstring
    exempt*: MagickBooleanType
    stealth*: MagickBooleanType
    signature*: uint
  ConfigureInfo* {.importc: "ConfigureInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    name*: cstring
    value*: cstring
    exempt*: MagickBooleanType
    stealth*: MagickBooleanType
    signature*: uint
  FrameInfo* {.importc: "FrameInfo", header: headerMagickWand, bycopy.} = object
    width*: uint
    height*: uint
    x*: cint
    y*: cint
    inner_bevel*: cint
    outer_bevel*: cint
  DelegateInfo* {.importc: "DelegateInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    decode*: cstring
    encode*: cstring
    commands*: cstring
  ...
  IsImageFormatHandler* = proc(a1: ptr cuchar,a2: uint): MagickBooleanType {.nimcall.}
  MagickInfo* {.importc: "MagickInfo", header: headerMagickWand, bycopy.} = object
    name*: cstring
    description*: cstring
    version*: cstring
    mime_type*: cstring
    ...
    signature*: uint
    client_data*: pointer
  BlobFifo* = proc(a1: ptr Image,a3: uint): cint {.nimcall.}
  ChannelFeatures* {.importc: "ChannelFeatures", header: headerMagickWand, bycopy.} = object
  ...
  MatrixInfo* = object
  MemoryInfo* = object
  ModuleInfo* {.importc: "ModuleInfo", header: headerMagickWand, bycopy.} = object
    path*: cstring
    tag*: cstring
    handle*: pointer
    unregister_module*: proc() {.nimcall.}
    register_module*: proc(): uint {.nimcall.}
    timestamp*: int32
    stealth*: MagickBooleanType
    signature*: uint
  MimeInfo* = object
  MontageInfo* {.importc: "MontageInfo", header: headerMagickWand, bycopy.} = object
    geometry*: cstring
    tile*: cstring
    title*: cstring
    frame*: cstring
  ...
  OptionInfo* {.importc: "OptionInfo", header: headerMagickWand, bycopy.} = object
    mnemonic*: cstring
    `type`*: cint
    flags*: cint
    stealth*: MagickBooleanType
  PolicyInfo* = object
  QuantizeInfo* {.importc: "QuantizeInfo", header: headerMagickWand, bycopy.} = object
    number_colors*: uint
    tree_depth*: uint
    colorspace*: ColorspaceType
  ...
  ChannelStatistics* {.importc: "ChannelStatistics", header: headerMagickWand, bycopy.} = object
    depth*: uint
    area*: cdouble
    minima*: cdouble
    maxima*: cdouble
  ...
  TokenInfo* = object
  ThresholdMap* = object
  CCObjectInfo* {.importc: "CCObjectInfo", header: headerMagickWand, bycopy.} = object
    id*: cint
    bounding_box*: RectangleInfo
    color*: PixelInfo
    centroid*: PointInfo
    ...
    census*: cdouble
  XMLTreeInfo* = object
  XImportInfo* {.importc: "XImportInfo", header: headerMagickWand, bycopy.} = object
...
proc GetGeometry*(a1: cstring,a2: ptr cint,a3: ptr cint,a4: ptr uint,a5: ptr uint): MagickStatusType {.importc: "GetGeometry", header: headerMagickWand.}
...
proc ParseMetaGeometry*(a1: cstring,a2: ptr cint,a3: ptr cint,a4: ptr uint,a5: ptr uint): MagickStatusType {.importc: "ParseMetaGeometry", header: headerMagickWand.}
...
proc GravityAdjustGeometry*(a1: uint,a2: uint,a3: GravityType,a4: ptr RectangleInfo) {.importc: "GravityAdjustGeometry", header: headerMagickWand.}
...
proc ExportImagePixels*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: cstring,a7: StorageType,a9: ptr ExceptionInfo): MagickBooleanType {.importc: "ExportImagePixels", header: headerMagickWand.}
proc ImportImagePixels*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: cstring,a7: StorageType,a9: ptr ExceptionInfo): MagickBooleanType {.importc: "ImportImagePixels", header: headerMagickWand.}
...
proc SetPixelMetaChannels*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): MagickBooleanType {.importc: "SetPixelMetaChannels", header: headerMagickWand.}
...
proc BlobToImage*(a1: ptr ImageInfo,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "BlobToImage", header: headerMagickWand.}
proc PingBlob*(a1: ptr ImageInfo,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "PingBlob", header: headerMagickWand.}
...
proc BlobToFile*(a1: cstring,a3: uint,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "BlobToFile", header: headerMagickWand.}
...
proc FileToBlob*(a1: cstring,a2: uint,a3: ptr uint,a4: ptr ExceptionInfo) {.importc: "FileToBlob", header: headerMagickWand.}
proc ImageToBlob*(a1: ptr ImageInfo,a2: ptr Image,a3: ptr uint,a4: ptr ExceptionInfo) {.importc: "ImageToBlob", header: headerMagickWand.}
...
proc ImagesToBlob*(a1: ptr ImageInfo,a2: ptr Image,a3: ptr uint,a4: ptr ExceptionInfo) {.importc: "ImagesToBlob", header: headerMagickWand.}
...
proc SetCustomStreamData*(a1: ptr CustomStreamInfo) {.importc: "SetCustomStreamData", header: headerMagickWand.}
...
proc GetCacheViewVirtualPixels*(a1: ptr CacheView,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "GetCacheViewVirtualPixels", header: headerMagickWand.}
...
proc GetCacheViewAuthenticPixels*(a1: ptr CacheView,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "GetCacheViewAuthenticPixels", header: headerMagickWand.}
proc QueueCacheViewAuthenticPixels*(a1: ptr CacheView,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "QueueCacheViewAuthenticPixels", header: headerMagickWand.}
...
proc ThrowMagickException*(a1: ptr ExceptionInfo,a2: cstring,a3: cstring,a4: uint,a5: ExceptionType,a6: cstring,a7: cstring): MagickBooleanType {.importc: "ThrowMagickException", header: headerMagickWand.}
...
proc LZWEncodeImage*(a1: ptr Image,a2: uint,a3: ptr cuchar,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "LZWEncodeImage", header: headerMagickWand.}
proc PackbitsEncodeImage*(a1: ptr Image,a2: uint,a3: ptr cuchar,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "PackbitsEncodeImage", header: headerMagickWand.}
proc ZLIBEncodeImage*(a1: ptr Image,a2: uint,a3: ptr cuchar,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "ZLIBEncodeImage", header: headerMagickWand.}
...
proc GetNumberOfElementsInLinkedList*(a1: ptr LinkedListInfo): uint {.importc: "GetNumberOfElementsInLinkedList", header: headerMagickWand.}
...
proc LocaleNCompare*(a1: cstring,a2: cstring,a3: uint): cint {.importc: "LocaleNCompare", header: headerMagickWand.}
...
proc FormatLocaleString*(a1: cstring,a2: uint,a3: cstring): cint {.importc: "FormatLocaleString", header: headerMagickWand.}
...
proc SetImageProgressMonitor*(a1: ptr Image,a2: MagickProgressMonitor): MagickProgressMonitor {.importc: "SetImageProgressMonitor", header: headerMagickWand.}
proc SetImageInfoProgressMonitor*(a1: ptr ImageInfo,a2: MagickProgressMonitor): MagickProgressMonitor {.importc: "SetImageInfoProgressMonitor", header: headerMagickWand.}
...
proc ConcatenateMagickString*(a1: cstring,a2: cstring,a3: uint): uint {.importc: "ConcatenateMagickString", header: headerMagickWand.}
proc CopyMagickString*(a1: cstring,a2: cstring,a3: uint): uint {.importc: "CopyMagickString", header: headerMagickWand.}
proc GetStringInfoLength*(a1: ptr StringInfo): uint {.importc: "GetStringInfoLength", header: headerMagickWand.}
proc FormatMagickSize*(a1: MagickSizeType,a2: MagickBooleanType,a3: cstring,a4: uint,a5: cstring): cint {.importc: "FormatMagickSize", header: headerMagickWand.}
proc FormatMagickTime*(a1: int32,a2: uint,a3: cstring): cint {.importc: "FormatMagickTime", header: headerMagickWand.}
proc AcquireStringInfo*(a1: uint): ptr StringInfo {.importc: "AcquireStringInfo", header: headerMagickWand.}
proc BlobToStringInfo*(a2: uint): ptr StringInfo {.importc: "BlobToStringInfo", header: headerMagickWand.}
...
proc FileToStringInfo*(a1: cstring,a2: uint,a3: ptr ExceptionInfo): ptr StringInfo {.importc: "FileToStringInfo", header: headerMagickWand.}
proc SplitStringInfo*(a1: ptr StringInfo,a2: uint): ptr StringInfo {.importc: "SplitStringInfo", header: headerMagickWand.}
...
proc SetStringInfoLength*(a1: ptr StringInfo,a2: uint) {.importc: "SetStringInfoLength", header: headerMagickWand.}
...
proc ProfileImage*(a1: ptr Image,a2: cstring,a4: uint,a5: ptr ExceptionInfo): MagickBooleanType {.importc: "ProfileImage", header: headerMagickWand.}
...
proc SetQuantumDepth*(a1: ptr Image,a2: ptr QuantumInfo,a3: uint): MagickBooleanType {.importc: "SetQuantumDepth", header: headerMagickWand.}
...
proc SetQuantumPad*(a1: ptr Image,a2: ptr QuantumInfo,a3: uint): MagickBooleanType {.importc: "SetQuantumPad", header: headerMagickWand.}
...
proc ExportQuantumPixels*(a1: ptr Image,a2: ptr CacheView,a3: ptr QuantumInfo,a4: QuantumType,a5: ptr cuchar,a6: ptr ExceptionInfo): uint {.importc: "ExportQuantumPixels", header: headerMagickWand.}
proc GetQuantumExtent*(a1: ptr Image,a2: ptr QuantumInfo,a3: QuantumType): uint {.importc: "GetQuantumExtent", header: headerMagickWand.}
proc ImportQuantumPixels*(a1: ptr Image,a2: ptr CacheView,a3: ptr QuantumInfo,a4: QuantumType,a5: ptr cuchar,a6: ptr ExceptionInfo): uint {.importc: "ImportQuantumPixels", header: headerMagickWand.}
...
proc SetQuantumQuantum*(a1: ptr QuantumInfo,a2: uint) {.importc: "SetQuantumQuantum", header: headerMagickWand.}
...
proc AdaptiveResizeImage*(a1: ptr Image,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "AdaptiveResizeImage", header: headerMagickWand.}
proc InterpolativeResizeImage*(a1: ptr Image,a2: uint,a3: uint,a4: PixelInterpolateMethod,a5: ptr ExceptionInfo): ptr Image {.importc: "InterpolativeResizeImage", header: headerMagickWand.}
proc LiquidRescaleImage*(a1: ptr Image,a2: uint,a3: uint,a4: cdouble,a5: cdouble,a6: ptr ExceptionInfo): ptr Image {.importc: "LiquidRescaleImage", header: headerMagickWand.}
...
proc ResizeImage*(a1: ptr Image,a2: uint,a3: uint,a4: FilterType,a5: ptr ExceptionInfo): ptr Image {.importc: "ResizeImage", header: headerMagickWand.}
proc SampleImage*(a1: ptr Image,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "SampleImage", header: headerMagickWand.}
proc ScaleImage*(a1: ptr Image,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "ScaleImage", header: headerMagickWand.}
proc ThumbnailImage*(a1: ptr Image,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "ThumbnailImage", header: headerMagickWand.}
...
proc CloneImage*(a1: ptr Image,a2: uint,a3: uint,a4: MagickBooleanType,a5: ptr ExceptionInfo): ptr Image {.importc: "CloneImage", header: headerMagickWand.}
...
proc NewMagickImage*(a1: ptr ImageInfo,a2: uint,a3: uint,a4: ptr PixelInfo,a5: ptr ExceptionInfo): ptr Image {.importc: "NewMagickImage", header: headerMagickWand.}
...
proc InterpretImageFilename*(a1: ptr ImageInfo,a2: ptr Image,a3: cstring,a4: cint,a5: cstring,a6: ptr ExceptionInfo): uint {.importc: "InterpretImageFilename", header: headerMagickWand.}
...
proc SetImageInfoBlob*(a1: ptr ImageInfo,a3: uint) {.importc: "SetImageInfoBlob", header: headerMagickWand.}
...
proc SetImageDepth*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): MagickBooleanType {.importc: "SetImageDepth", header: headerMagickWand.}
...
proc GetImageDepth*(a1: ptr Image,a2: ptr ExceptionInfo): uint {.importc: "GetImageDepth", header: headerMagickWand.}
proc GetImageQuantumDepth*(a1: ptr Image,a2: MagickBooleanType): uint {.importc: "GetImageQuantumDepth", header: headerMagickWand.}
...
proc GetVirtualPixels*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "GetVirtualPixels", header: headerMagickWand.}
...
proc GetAuthenticPixels*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "GetAuthenticPixels", header: headerMagickWand.}
proc GetAuthenticPixelQueue*(a1: ptr Image): ptr Quantum {.importc: "GetAuthenticPixelQueue", header: headerMagickWand.}
proc QueueAuthenticPixels*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr Quantum {.importc: "QueueAuthenticPixels", header: headerMagickWand.}
proc AcquirePixelCachePixels*(a1: ptr Image,a2: ptr uint,a3: ptr ExceptionInfo) {.importc: "AcquirePixelCachePixels", header: headerMagickWand.}
...
proc AcquireImageColormap*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): MagickBooleanType {.importc: "AcquireImageColormap", header: headerMagickWand.}
...
proc ConstituteImage*(a1: uint,a2: uint,a3: cstring,a4: StorageType,a6: ptr ExceptionInfo): ptr Image {.importc: "ConstituteImage", header: headerMagickWand.}
...
proc GetImageMagick*(a1: ptr cuchar,a2: uint,a3: cstring): MagickBooleanType {.importc: "GetImageMagick", header: headerMagickWand.}
...
proc DistortImage*(a1: ptr Image,a2: DistortMethod,a3: uint,a4: ptr cdouble,a5: MagickBooleanType,exception: ptr ExceptionInfo): ptr Image {.importc: "DistortImage", header: headerMagickWand.}
proc DistortResizeImage*(a1: ptr Image,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr Image {.importc: "DistortResizeImage", header: headerMagickWand.}
proc RotateImage*(a1: ptr Image,a2: cdouble,a3: ptr ExceptionInfo): ptr Image {.importc: "RotateImage", header: headerMagickWand.}
proc SparseColorImage*(a1: ptr Image,a2: SparseColorMethod,a3: uint,a4: ptr cdouble,a5: ptr ExceptionInfo): ptr Image {.importc: "SparseColorImage", header: headerMagickWand.}
...
proc CLAHEImage*(a1: ptr Image,a2: uint,a3: uint,a4: uint,a5: cdouble,a6: ptr ExceptionInfo): MagickBooleanType {.importc: "CLAHEImage", header: headerMagickWand.}
...
proc GetImageFeatures*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): ptr ChannelFeatures {.importc: "GetImageFeatures", header: headerMagickWand.}
...
proc HoughLineImage*(a1: ptr Image,a2: uint,a3: uint,a4: uint,a5: ptr ExceptionInfo): ptr Image {.importc: "HoughLineImage", header: headerMagickWand.}
proc MeanShiftImage*(a1: ptr Image,a2: uint,a3: uint,a4: cdouble,a5: ptr ExceptionInfo): ptr Image {.importc: "MeanShiftImage", header: headerMagickWand.}
...
proc MorphImages*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): ptr Image {.importc: "MorphImages", header: headerMagickWand.}
...
proc PlasmaImage*(a1: ptr Image,a2: ptr SegmentInfo,a3: uint,a4: uint,a5: ptr ExceptionInfo): MagickBooleanType {.importc: "PlasmaImage", header: headerMagickWand.}
...
proc GetRandomKey*(a1: ptr RandomInfo,a2: uint): ptr StringInfo {.importc: "GetRandomKey", header: headerMagickWand.}
proc GetRandomSecretKey*(a1: ptr RandomInfo): culong {.importc: "GetRandomSecretKey", header: headerMagickWand.}
proc SetRandomKey*(a1: ptr RandomInfo,a2: uint,a3: ptr cuchar) {.importc: "SetRandomKey", header: headerMagickWand.}
...
proc GetImageHistogram*(a1: ptr Image,a2: ptr uint,a3: ptr ExceptionInfo): ptr PixelInfo {.importc: "GetImageHistogram", header: headerMagickWand.}
...
proc GetNumberColors*(a1: ptr Image,a2: ptr FILE,a3: ptr ExceptionInfo): uint {.importc: "GetNumberColors", header: headerMagickWand.}
...
proc NewImageViewRegion*(a1: ptr Image,a2: cint,a3: cint,a4: uint,a5: uint,a6: ptr ExceptionInfo): ptr ImageView {.importc: "NewImageViewRegion", header: headerMagickWand.}
...
proc SetImageViewThreads*(a1: ptr ImageView,a2: uint) {.importc: "SetImageViewThreads", header: headerMagickWand.}
proc GetImageViewAuthenticMetacontent*(a1: ptr ImageView) {.importc: "GetImageViewAuthenticMetacontent", header: headerMagickWand.}
proc GetImageListLength*(a1: ptr Image): uint {.importc: "GetImageListLength", header: headerMagickWand.}
...
proc LogMagickEvent*(a1: LogEventType,a2: cstring,a3: cstring,a4: uint,a5: cstring): MagickBooleanType {.importc: "LogMagickEvent", header: headerMagickWand.}
...
proc GetMagicPatternExtent*(a1: ptr ExceptionInfo): uint {.importc: "GetMagicPatternExtent", header: headerMagickWand.}
proc MatrixToImage*(a1: ptr MatrixInfo,a2: ptr ExceptionInfo): ptr Image {.importc: "MatrixToImage", header: headerMagickWand.}
proc GetMatrixElement*(a1: ptr MatrixInfo,a2: cint,a3: cint): MagickBooleanType {.importc: "GetMatrixElement", header: headerMagickWand.}
proc NullMatrix*(a1: ptr MatrixInfo): MagickBooleanType {.importc: "NullMatrix", header: headerMagickWand.}
proc SetMatrixElement*(a1: ptr MatrixInfo,a2: cint,a3: cint): MagickBooleanType {.importc: "SetMatrixElement", header: headerMagickWand.}
proc AcquireMatrixInfo*(a1: uint,a2: uint,a3: uint,a4: ptr ExceptionInfo): ptr MatrixInfo {.importc: "AcquireMatrixInfo", header: headerMagickWand.}
proc DestroyMatrixInfo*(a1: ptr MatrixInfo): ptr MatrixInfo {.importc: "DestroyMatrixInfo", header: headerMagickWand.}
proc GetMatrixColumns*(a1: ptr MatrixInfo): uint {.importc: "GetMatrixColumns", header: headerMagickWand.}
proc GetMatrixRows*(a1: ptr MatrixInfo): uint {.importc: "GetMatrixRows", header: headerMagickWand.}
proc AcquireVirtualMemory*(a1: uint,a2: uint): ptr MemoryInfo {.importc: "AcquireVirtualMemory", header: headerMagickWand.}
proc RelinquishVirtualMemory*(a1: ptr MemoryInfo): ptr MemoryInfo {.importc: "RelinquishVirtualMemory", header: headerMagickWand.}
proc AcquireAlignedMemory*(a1: uint,a2: uint) {.importc: "AcquireAlignedMemory", header: headerMagickWand.}
proc AcquireMagickMemory*(a1: uint) {.importc: "AcquireMagickMemory", header: headerMagickWand.}
...
proc GetMagickQuantumDepth*(a1: ptr uint): cstring {.importc: "GetMagickQuantumDepth", header: headerMagickWand.}
proc GetMagickQuantumRange*(a1: ptr uint): cstring {.importc: "GetMagickQuantumRange", header: headerMagickWand.}
proc GetMagickReleaseDate*(): cstring {.importc: "GetMagickReleaseDate", header: headerMagickWand.}
proc GetMagickVersion*(a1: ptr uint): cstring {.importc: "GetMagickVersion", header: headerMagickWand.}
...
proc GetOpenCLDevices*(a1: ptr uint,a2: ptr ExceptionInfo): ptr MagickCLDevice {.importc: "GetOpenCLDevices", header: headerMagickWand.}
...
proc GradientImage*(a1: ptr Image,a2: GradientType,a3: SpreadMethod,a4: ptr StopInfo,a5: uint,a6: ptr ExceptionInfo): MagickBooleanType {.importc: "GradientImage", header: headerMagickWand.}
...
proc GetPixelChannels*(image: ptr Image): uint {.importc: "GetPixelChannels", header: headerMagickWand.}
...
proc GetPixelMetaChannels*(image: ptr Image): uint {.importc: "GetPixelMetaChannels", header: headerMagickWand.}
proc GetPixelMetacontentExtent*(image: ptr Image): uint {.importc: "GetPixelMetacontentExtent", header: headerMagickWand.}
...
proc SetPixelChannels*(image: ptr Image,number_channels: uint) {.importc: "SetPixelChannels", header: headerMagickWand.}
...
proc SetPixelMetacontentExtent*(image: ptr Image,extent: uint) {.importc: "SetPixelMetacontentExtent", header: headerMagickWand.}
...
proc PosterizeImage*(a1: ptr Image,a2: uint,a3: DitherMethod,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "PosterizeImage", header: headerMagickWand.}
...
proc SetImageRegistry*(a1: RegistryType,a2: cstring,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "SetImageRegistry", header: headerMagickWand.}
...
proc IntegralRotateImage*(a1: ptr Image,a2: uint,a3: ptr ExceptionInfo): ptr Image {.importc: "IntegralRotateImage", header: headerMagickWand.}
...
proc AddValueToSplayTree*(a1: ptr SplayTreeInfo): MagickBooleanType {.importc: "AddValueToSplayTree", header: headerMagickWand.}
proc DeleteNodeByValueFromSplayTree*(a1: ptr SplayTreeInfo): MagickBooleanType {.importc: "DeleteNodeByValueFromSplayTree", header: headerMagickWand.}
proc DeleteNodeFromSplayTree*(a1: ptr SplayTreeInfo): MagickBooleanType {.importc: "DeleteNodeFromSplayTree", header: headerMagickWand.}
...
proc GetValueFromSplayTree*(a1: ptr SplayTreeInfo) {.importc: "GetValueFromSplayTree", header: headerMagickWand.}
proc CompareSplayTreeString*(): cint {.importc: "CompareSplayTreeString", header: headerMagickWand.}
proc CompareSplayTreeStringInfo*(): cint {.importc: "CompareSplayTreeStringInfo", header: headerMagickWand.}
proc GetNumberOfNodesInSplayTree*(a1: ptr SplayTreeInfo): uint {.importc: "GetNumberOfNodesInSplayTree", header: headerMagickWand.}
proc RemoveNodeByValueFromSplayTree*(a1: ptr SplayTreeInfo) {.importc: "RemoveNodeByValueFromSplayTree", header: headerMagickWand.}
proc RemoveNodeFromSplayTree*(a1: ptr SplayTreeInfo) {.importc: "RemoveNodeFromSplayTree", header: headerMagickWand.}
...
proc RegisterAAIImage*(): uint {.importc: "RegisterAAIImage", header: headerMagickWand.}
proc RegisterARTImage*(): uint {.importc: "RegisterARTImage", header: headerMagickWand.}
proc RegisterAVIImage*(): uint {.importc: "RegisterAVIImage", header: headerMagickWand.}
proc RegisterAVSImage*(): uint {.importc: "RegisterAVSImage", header: headerMagickWand.}
proc RegisterBIEImage*(): uint {.importc: "RegisterBIEImage", header: headerMagickWand.}
proc RegisterBGRImage*(): uint {.importc: "RegisterBGRImage", header: headerMagickWand.}
proc RegisterBMPImage*(): uint {.importc: "RegisterBMPImage", header: headerMagickWand.}
proc RegisterBRAILLEImage*(): uint {.importc: "RegisterBRAILLEImage", header: headerMagickWand.}
proc RegisterCALSImage*(): uint {.importc: "RegisterCALSImage", header: headerMagickWand.}
proc RegisterCAPTIONImage*(): uint {.importc: "RegisterCAPTIONImage", header: headerMagickWand.}
proc RegisterCINImage*(): uint {.importc: "RegisterCINImage", header: headerMagickWand.}
proc RegisterCIPImage*(): uint {.importc: "RegisterCIPImage", header: headerMagickWand.}
proc RegisterCLIPImage*(): uint {.importc: "RegisterCLIPImage", header: headerMagickWand.}
proc RegisterCLIPBOARDImage*(): uint {.importc: "RegisterCLIPBOARDImage", header: headerMagickWand.}
proc RegisterCMYKImage*(): uint {.importc: "RegisterCMYKImage", header: headerMagickWand.}
proc RegisterCUBEImage*(): uint {.importc: "RegisterCUBEImage", header: headerMagickWand.}
proc RegisterCUTImage*(): uint {.importc: "RegisterCUTImage", header: headerMagickWand.}
proc RegisterDCMImage*(): uint {.importc: "RegisterDCMImage", header: headerMagickWand.}
proc RegisterDCXImage*(): uint {.importc: "RegisterDCXImage", header: headerMagickWand.}
proc RegisterDDSImage*(): uint {.importc: "RegisterDDSImage", header: headerMagickWand.}
proc RegisterDEBUGImage*(): uint {.importc: "RegisterDEBUGImage", header: headerMagickWand.}
proc RegisterDIBImage*(): uint {.importc: "RegisterDIBImage", header: headerMagickWand.}
proc RegisterDJVUImage*(): uint {.importc: "RegisterDJVUImage", header: headerMagickWand.}
proc RegisterDNGImage*(): uint {.importc: "RegisterDNGImage", header: headerMagickWand.}
proc RegisterDPSImage*(): uint {.importc: "RegisterDPSImage", header: headerMagickWand.}
proc RegisterDPXImage*(): uint {.importc: "RegisterDPXImage", header: headerMagickWand.}
proc RegisterEMFImage*(): uint {.importc: "RegisterEMFImage", header: headerMagickWand.}
proc RegisterEPDFImage*(): uint {.importc: "RegisterEPDFImage", header: headerMagickWand.}
proc RegisterEPIImage*(): uint {.importc: "RegisterEPIImage", header: headerMagickWand.}
proc RegisterEPSImage*(): uint {.importc: "RegisterEPSImage", header: headerMagickWand.}
proc RegisterEPS2Image*(): uint {.importc: "RegisterEPS2Image", header: headerMagickWand.}
proc RegisterEPSFImage*(): uint {.importc: "RegisterEPSFImage", header: headerMagickWand.}
proc RegisterEPSIImage*(): uint {.importc: "RegisterEPSIImage", header: headerMagickWand.}
proc RegisterEPTImage*(): uint {.importc: "RegisterEPTImage", header: headerMagickWand.}
proc RegisterEXRImage*(): uint {.importc: "RegisterEXRImage", header: headerMagickWand.}
proc RegisterFAXImage*(): uint {.importc: "RegisterFAXImage", header: headerMagickWand.}
proc RegisterFITSImage*(): uint {.importc: "RegisterFITSImage", header: headerMagickWand.}
proc RegisterFLIFImage*(): uint {.importc: "RegisterFLIFImage", header: headerMagickWand.}
proc RegisterFPXImage*(): uint {.importc: "RegisterFPXImage", header: headerMagickWand.}
proc RegisterG3Image*(): uint {.importc: "RegisterG3Image", header: headerMagickWand.}
proc RegisterGIFImage*(): uint {.importc: "RegisterGIFImage", header: headerMagickWand.}
proc RegisterGIF87Image*(): uint {.importc: "RegisterGIF87Image", header: headerMagickWand.}
proc RegisterGRADIENTImage*(): uint {.importc: "RegisterGRADIENTImage", header: headerMagickWand.}
proc RegisterGRANITEImage*(): uint {.importc: "RegisterGRANITEImage", header: headerMagickWand.}
proc RegisterGRAYImage*(): uint {.importc: "RegisterGRAYImage", header: headerMagickWand.}
proc RegisterHALDImage*(): uint {.importc: "RegisterHALDImage", header: headerMagickWand.}
proc RegisterHDRImage*(): uint {.importc: "RegisterHDRImage", header: headerMagickWand.}
proc RegisterHEICImage*(): uint {.importc: "RegisterHEICImage", header: headerMagickWand.}
proc RegisterHImage*(): uint {.importc: "RegisterHImage", header: headerMagickWand.}
proc RegisterHISTOGRAMImage*(): uint {.importc: "RegisterHISTOGRAMImage", header: headerMagickWand.}
proc RegisterHRZImage*(): uint {.importc: "RegisterHRZImage", header: headerMagickWand.}
proc RegisterHTMLImage*(): uint {.importc: "RegisterHTMLImage", header: headerMagickWand.}
proc RegisterICBImage*(): uint {.importc: "RegisterICBImage", header: headerMagickWand.}
proc RegisterICONImage*(): uint {.importc: "RegisterICONImage", header: headerMagickWand.}
proc RegisterINFOImage*(): uint {.importc: "RegisterINFOImage", header: headerMagickWand.}
proc RegisterINLINEImage*(): uint {.importc: "RegisterINLINEImage", header: headerMagickWand.}
proc RegisterIPLImage*(): uint {.importc: "RegisterIPLImage", header: headerMagickWand.}
proc RegisterJBGImage*(): uint {.importc: "RegisterJBGImage", header: headerMagickWand.}
proc RegisterJBIGImage*(): uint {.importc: "RegisterJBIGImage", header: headerMagickWand.}
proc RegisterJNXImage*(): uint {.importc: "RegisterJNXImage", header: headerMagickWand.}
proc RegisterJPEGImage*(): uint {.importc: "RegisterJPEGImage", header: headerMagickWand.}
proc RegisterJSONImage*(): uint {.importc: "RegisterJSONImage", header: headerMagickWand.}
proc RegisterJP2Image*(): uint {.importc: "RegisterJP2Image", header: headerMagickWand.}
proc RegisterLABELImage*(): uint {.importc: "RegisterLABELImage", header: headerMagickWand.}
proc RegisterMACImage*(): uint {.importc: "RegisterMACImage", header: headerMagickWand.}
proc RegisterMAGICKImage*(): uint {.importc: "RegisterMAGICKImage", header: headerMagickWand.}
proc RegisterMAPImage*(): uint {.importc: "RegisterMAPImage", header: headerMagickWand.}
proc RegisterMASKImage*(): uint {.importc: "RegisterMASKImage", header: headerMagickWand.}
proc RegisterMATImage*(): uint {.importc: "RegisterMATImage", header: headerMagickWand.}
proc RegisterMATTEImage*(): uint {.importc: "RegisterMATTEImage", header: headerMagickWand.}
proc RegisterMETAImage*(): uint {.importc: "RegisterMETAImage", header: headerMagickWand.}
proc RegisterMIFFImage*(): uint {.importc: "RegisterMIFFImage", header: headerMagickWand.}
proc RegisterMNGImage*(): uint {.importc: "RegisterMNGImage", header: headerMagickWand.}
proc RegisterMONOImage*(): uint {.importc: "RegisterMONOImage", header: headerMagickWand.}
proc RegisterMPCImage*(): uint {.importc: "RegisterMPCImage", header: headerMagickWand.}
proc RegisterMPEGImage*(): uint {.importc: "RegisterMPEGImage", header: headerMagickWand.}
proc RegisterMPRImage*(): uint {.importc: "RegisterMPRImage", header: headerMagickWand.}
proc RegisterMSLImage*(): uint {.importc: "RegisterMSLImage", header: headerMagickWand.}
proc RegisterMTVImage*(): uint {.importc: "RegisterMTVImage", header: headerMagickWand.}
proc RegisterMVGImage*(): uint {.importc: "RegisterMVGImage", header: headerMagickWand.}
proc RegisterNETSCAPEImage*(): uint {.importc: "RegisterNETSCAPEImage", header: headerMagickWand.}
proc RegisterNULLImage*(): uint {.importc: "RegisterNULLImage", header: headerMagickWand.}
proc RegisterP7Image*(): uint {.importc: "RegisterP7Image", header: headerMagickWand.}
proc RegisterPBMImage*(): uint {.importc: "RegisterPBMImage", header: headerMagickWand.}
proc RegisterOTBImage*(): uint {.importc: "RegisterOTBImage", header: headerMagickWand.}
proc RegisterPALMImage*(): uint {.importc: "RegisterPALMImage", header: headerMagickWand.}
proc RegisterPANGOImage*(): uint {.importc: "RegisterPANGOImage", header: headerMagickWand.}
proc RegisterPATTERNImage*(): uint {.importc: "RegisterPATTERNImage", header: headerMagickWand.}
proc RegisterPCDImage*(): uint {.importc: "RegisterPCDImage", header: headerMagickWand.}
proc RegisterPCDSImage*(): uint {.importc: "RegisterPCDSImage", header: headerMagickWand.}
proc RegisterPCLImage*(): uint {.importc: "RegisterPCLImage", header: headerMagickWand.}
proc RegisterPCTImage*(): uint {.importc: "RegisterPCTImage", header: headerMagickWand.}
proc RegisterPCXImage*(): uint {.importc: "RegisterPCXImage", header: headerMagickWand.}
proc RegisterPDBImage*(): uint {.importc: "RegisterPDBImage", header: headerMagickWand.}
proc RegisterPDFImage*(): uint {.importc: "RegisterPDFImage", header: headerMagickWand.}
proc RegisterPESImage*(): uint {.importc: "RegisterPESImage", header: headerMagickWand.}
proc RegisterPGXImage*(): uint {.importc: "RegisterPGXImage", header: headerMagickWand.}
proc RegisterPICImage*(): uint {.importc: "RegisterPICImage", header: headerMagickWand.}
proc RegisterPICTImage*(): uint {.importc: "RegisterPICTImage", header: headerMagickWand.}
proc RegisterPIXImage*(): uint {.importc: "RegisterPIXImage", header: headerMagickWand.}
proc RegisterPGMImage*(): uint {.importc: "RegisterPGMImage", header: headerMagickWand.}
proc RegisterPLASMAImage*(): uint {.importc: "RegisterPLASMAImage", header: headerMagickWand.}
proc RegisterPMImage*(): uint {.importc: "RegisterPMImage", header: headerMagickWand.}
proc RegisterPNGImage*(): uint {.importc: "RegisterPNGImage", header: headerMagickWand.}
proc RegisterPNMImage*(): uint {.importc: "RegisterPNMImage", header: headerMagickWand.}
proc RegisterPPMImage*(): uint {.importc: "RegisterPPMImage", header: headerMagickWand.}
proc RegisterPSImage*(): uint {.importc: "RegisterPSImage", header: headerMagickWand.}
proc RegisterPS2Image*(): uint {.importc: "RegisterPS2Image", header: headerMagickWand.}
proc RegisterPS3Image*(): uint {.importc: "RegisterPS3Image", header: headerMagickWand.}
proc RegisterPSDImage*(): uint {.importc: "RegisterPSDImage", header: headerMagickWand.}
proc RegisterPTIFImage*(): uint {.importc: "RegisterPTIFImage", header: headerMagickWand.}
proc RegisterPWPImage*(): uint {.importc: "RegisterPWPImage", header: headerMagickWand.}
proc RegisterRASImage*(): uint {.importc: "RegisterRASImage", header: headerMagickWand.}
proc RegisterRAWImage*(): uint {.importc: "RegisterRAWImage", header: headerMagickWand.}
proc RegisterRGBImage*(): uint {.importc: "RegisterRGBImage", header: headerMagickWand.}
proc RegisterRGBAImage*(): uint {.importc: "RegisterRGBAImage", header: headerMagickWand.}
proc RegisterRGFImage*(): uint {.importc: "RegisterRGFImage", header: headerMagickWand.}
proc RegisterRLAImage*(): uint {.importc: "RegisterRLAImage", header: headerMagickWand.}
proc RegisterRLEImage*(): uint {.importc: "RegisterRLEImage", header: headerMagickWand.}
proc RegisterSCRImage*(): uint {.importc: "RegisterSCRImage", header: headerMagickWand.}
proc RegisterSCREENSHOTImage*(): uint {.importc: "RegisterSCREENSHOTImage", header: headerMagickWand.}
proc RegisterSCTImage*(): uint {.importc: "RegisterSCTImage", header: headerMagickWand.}
proc RegisterSFWImage*(): uint {.importc: "RegisterSFWImage", header: headerMagickWand.}
proc RegisterSGIImage*(): uint {.importc: "RegisterSGIImage", header: headerMagickWand.}
proc RegisterSHTMLImage*(): uint {.importc: "RegisterSHTMLImage", header: headerMagickWand.}
proc RegisterSIXELImage*(): uint {.importc: "RegisterSIXELImage", header: headerMagickWand.}
proc RegisterSTEGANOImage*(): uint {.importc: "RegisterSTEGANOImage", header: headerMagickWand.}
proc RegisterSUNImage*(): uint {.importc: "RegisterSUNImage", header: headerMagickWand.}
proc RegisterSVGImage*(): uint {.importc: "RegisterSVGImage", header: headerMagickWand.}
proc RegisterTEXTImage*(): uint {.importc: "RegisterTEXTImage", header: headerMagickWand.}
proc RegisterTGAImage*(): uint {.importc: "RegisterTGAImage", header: headerMagickWand.}
proc RegisterTHUMBNAILImage*(): uint {.importc: "RegisterTHUMBNAILImage", header: headerMagickWand.}
proc RegisterTIFImage*(): uint {.importc: "RegisterTIFImage", header: headerMagickWand.}
proc RegisterTIFFImage*(): uint {.importc: "RegisterTIFFImage", header: headerMagickWand.}
proc RegisterTILEImage*(): uint {.importc: "RegisterTILEImage", header: headerMagickWand.}
proc RegisterTIMImage*(): uint {.importc: "RegisterTIMImage", header: headerMagickWand.}
proc RegisterTTFImage*(): uint {.importc: "RegisterTTFImage", header: headerMagickWand.}
proc RegisterTXTImage*(): uint {.importc: "RegisterTXTImage", header: headerMagickWand.}
proc RegisterUILImage*(): uint {.importc: "RegisterUILImage", header: headerMagickWand.}
proc RegisterURLImage*(): uint {.importc: "RegisterURLImage", header: headerMagickWand.}
proc RegisterUYVYImage*(): uint {.importc: "RegisterUYVYImage", header: headerMagickWand.}
proc RegisterVDAImage*(): uint {.importc: "RegisterVDAImage", header: headerMagickWand.}
proc RegisterVICARImage*(): uint {.importc: "RegisterVICARImage", header: headerMagickWand.}
proc RegisterVIDImage*(): uint {.importc: "RegisterVIDImage", header: headerMagickWand.}
proc RegisterVIFFImage*(): uint {.importc: "RegisterVIFFImage", header: headerMagickWand.}
proc RegisterVIPSImage*(): uint {.importc: "RegisterVIPSImage", header: headerMagickWand.}
proc RegisterVSTImage*(): uint {.importc: "RegisterVSTImage", header: headerMagickWand.}
proc RegisterWBMPImage*(): uint {.importc: "RegisterWBMPImage", header: headerMagickWand.}
proc RegisterWEBPImage*(): uint {.importc: "RegisterWEBPImage", header: headerMagickWand.}
proc RegisterWMFImage*(): uint {.importc: "RegisterWMFImage", header: headerMagickWand.}
proc RegisterWPGImage*(): uint {.importc: "RegisterWPGImage", header: headerMagickWand.}
proc RegisterXImage*(): uint {.importc: "RegisterXImage", header: headerMagickWand.}
proc RegisterXBMImage*(): uint {.importc: "RegisterXBMImage", header: headerMagickWand.}
proc RegisterXCImage*(): uint {.importc: "RegisterXCImage", header: headerMagickWand.}
proc RegisterXCFImage*(): uint {.importc: "RegisterXCFImage", header: headerMagickWand.}
proc RegisterXPMImage*(): uint {.importc: "RegisterXPMImage", header: headerMagickWand.}
proc RegisterXPSImage*(): uint {.importc: "RegisterXPSImage", header: headerMagickWand.}
proc RegisterXTRNImage*(): uint {.importc: "RegisterXTRNImage", header: headerMagickWand.}
proc RegisterXVImage*(): uint {.importc: "RegisterXVImage", header: headerMagickWand.}
proc RegisterXWDImage*(): uint {.importc: "RegisterXWDImage", header: headerMagickWand.}
proc RegisterYCBCRImage*(): uint {.importc: "RegisterYCBCRImage", header: headerMagickWand.}
proc RegisterYUVImage*(): uint {.importc: "RegisterYUVImage", header: headerMagickWand.}
...
proc PolynomialImage*(a1: ptr Image,a2: uint,a3: ptr cdouble,a4: ptr ExceptionInfo): ptr Image {.importc: "PolynomialImage", header: headerMagickWand.}
proc StatisticImage*(a1: ptr Image,a2: StatisticType,a3: uint,a4: uint,a5: ptr ExceptionInfo): ptr Image {.importc: "StatisticImage", header: headerMagickWand.}
...
proc FunctionImage*(a1: ptr Image,a2: MagickFunction,a3: uint,a4: ptr cdouble,a5: ptr ExceptionInfo): MagickBooleanType {.importc: "FunctionImage", header: headerMagickWand.}
...
proc GetImageExtrema*(a1: ptr Image,a2: ptr uint,a3: ptr uint,a4: ptr ExceptionInfo): MagickBooleanType {.importc: "GetImageExtrema", header: headerMagickWand.}
...
proc Tokenizer*(a1: ptr TokenInfo,a2: cuint,a3: cstring,a4: uint,a5: cstring,a6: cstring,a7: cstring,a8: cstring,a9: cchar,a10: cstring,a11: ptr cint,a12: cstring): cint {.importc: "Tokenizer", header: headerMagickWand.}
...
proc AdaptiveThresholdImage*(a1: ptr Image,a2: uint,a3: uint,a4: cdouble,a5: ptr ExceptionInfo): ptr Image {.importc: "AdaptiveThresholdImage", header: headerMagickWand.}
...
proc Base64Encode*(a1: ptr cuchar,a2: uint,a3: ptr uint): cstring {.importc: "Base64Encode", header: headerMagickWand.}
proc MultilineCensus*(a1: cstring): uint {.importc: "MultilineCensus", header: headerMagickWand.}
proc Base64Decode*(a1: cstring,a2: ptr uint): ptr cuchar {.importc: "Base64Decode", header: headerMagickWand.}
...
proc AddChildToXMLTree*(a1: ptr XMLTreeInfo,a2: cstring,a3: uint): ptr XMLTreeInfo {.importc: "AddChildToXMLTree", header: headerMagickWand.}
...
proc PixelGetColorCount*(a1: ptr PixelWand): uint {.importc: "PixelGetColorCount", header: headerMagickWand.}
...
proc PixelSetColorCount*(a1: ptr PixelWand,a2: uint) {.importc: "PixelSetColorCount", header: headerMagickWand.}
...
proc DrawGetStrokeDashArray*(a1: ptr DrawingWand,a2: ptr uint): ptr cdouble {.importc: "DrawGetStrokeDashArray", header: headerMagickWand.}
...
proc DrawSetStrokeDashArray*(a1: ptr DrawingWand,a2: uint,a3: ptr cdouble): MagickBooleanType {.importc: "DrawSetStrokeDashArray", header: headerMagickWand.}
...
proc DrawGetFontWeight*(a1: ptr DrawingWand): uint {.importc: "DrawGetFontWeight", header: headerMagickWand.}
proc DrawGetStrokeMiterLimit*(a1: ptr DrawingWand): uint {.importc: "DrawGetStrokeMiterLimit", header: headerMagickWand.}
...
proc DrawBezier*(a1: ptr DrawingWand,a2: uint,a3: ptr PointInfo) {.importc: "DrawBezier", header: headerMagickWand.}
...
proc DrawPolygon*(a1: ptr DrawingWand,a2: uint,a3: ptr PointInfo) {.importc: "DrawPolygon", header: headerMagickWand.}
proc DrawPolyline*(a1: ptr DrawingWand,a2: uint,a3: ptr PointInfo) {.importc: "DrawPolyline", header: headerMagickWand.}
...
proc DrawSetFontWeight*(a1: ptr DrawingWand,a2: uint) {.importc: "DrawSetFontWeight", header: headerMagickWand.}
...
proc DrawSetStrokeMiterLimit*(a1: ptr DrawingWand,a2: uint) {.importc: "DrawSetStrokeMiterLimit", header: headerMagickWand.}
...
proc CLILogEvent*(a1: ptr MagickCLI,a2: LogEventType,a3: cstring,a4: cstring,a5: uint,a6: cstring): MagickBooleanType {.importc: "CLILogEvent", header: headerMagickWand.}
proc CLIThrowException*(a1: ptr MagickCLI,a2: cstring,a3: cstring,a4: uint,a5: ExceptionType,a6: cstring,a7: cstring): MagickBooleanType {.importc: "CLIThrowException", header: headerMagickWand.}
...
proc MagickGetQuantumDepth*(a1: ptr uint): cstring {.importc: "MagickGetQuantumDepth", header: headerMagickWand.}
proc MagickGetQuantumRange*(a1: ptr uint): cstring {.importc: "MagickGetQuantumRange", header: headerMagickWand.}
proc MagickGetReleaseDate*(): cstring {.importc: "MagickGetReleaseDate", header: headerMagickWand.}
proc MagickGetVersion*(a1: ptr uint): cstring {.importc: "MagickGetVersion", header: headerMagickWand.}
proc MagickGetPointsize*(a1: ptr MagickWand): cdouble {.importc: "MagickGetPointsize", header: headerMagickWand.}
proc MagickGetSamplingFactors*(a1: ptr MagickWand,a2: ptr uint): ptr cdouble {.importc: "MagickGetSamplingFactors", header: headerMagickWand.}
...
proc MagickGetPage*(a1: ptr MagickWand,a2: ptr uint,a3: ptr uint,a4: ptr cint,a5: ptr cint): MagickBooleanType {.importc: "MagickGetPage", header: headerMagickWand.}
...
proc MagickGetSize*(a1: ptr MagickWand,a2: ptr uint,a3: ptr uint): MagickBooleanType {.importc: "MagickGetSize", header: headerMagickWand.}
...
proc MagickProfileImage*(a1: ptr MagickWand,a2: cstring,a4: uint): MagickBooleanType {.importc: "MagickProfileImage", header: headerMagickWand.}
...
proc MagickSetCompressionQuality*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetCompressionQuality", header: headerMagickWand.}
proc MagickSetDepth*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetDepth", header: headerMagickWand.}
...
proc MagickSetImageProfile*(a1: ptr MagickWand,a2: cstring,a4: uint): MagickBooleanType {.importc: "MagickSetImageProfile", header: headerMagickWand.}
...
proc MagickSetPage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickSetPage", header: headerMagickWand.}
...
proc MagickSetSamplingFactors*(a1: ptr MagickWand,a2: uint,a3: ptr cdouble): MagickBooleanType {.importc: "MagickSetSamplingFactors", header: headerMagickWand.}
...
proc MagickSetSize*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickSetSize", header: headerMagickWand.}
proc MagickSetSizeOffset*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint): MagickBooleanType {.importc: "MagickSetSizeOffset", header: headerMagickWand.}
proc MagickSetType*(a1: ptr MagickWand,a2: ImageType): MagickBooleanType {.importc: "MagickSetType", header: headerMagickWand.}
proc MagickSetProgressMonitor*(a1: ptr MagickWand,a2: MagickProgressMonitor): MagickProgressMonitor {.importc: "MagickSetProgressMonitor", header: headerMagickWand.}
...
proc MagickGetCompressionQuality*(a1: ptr MagickWand): uint {.importc: "MagickGetCompressionQuality", header: headerMagickWand.}
proc MagickGetImageProfile*(a1: ptr MagickWand,a2: cstring,a3: ptr uint): ptr cuchar {.importc: "MagickGetImageProfile", header: headerMagickWand.}
proc MagickRemoveImageProfile*(a1: ptr MagickWand,a2: cstring,a3: ptr uint): ptr cuchar {.importc: "MagickRemoveImageProfile", header: headerMagickWand.}
proc MagickGetImageFeatures*(a1: ptr MagickWand,a2: uint): ptr ChannelFeatures {.importc: "MagickGetImageFeatures", header: headerMagickWand.}
...
proc MagickAdaptiveResizeImage*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickAdaptiveResizeImage", header: headerMagickWand.}
...
proc MagickAdaptiveThresholdImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cdouble): MagickBooleanType {.importc: "MagickAdaptiveThresholdImage", header: headerMagickWand.}
...
proc MagickBorderImage*(a1: ptr MagickWand,a2: ptr PixelWand,a3: uint,a4: uint,compose: CompositeOperator): MagickBooleanType {.importc: "MagickBorderImage", header: headerMagickWand.}
...
proc MagickChopImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickChopImage", header: headerMagickWand.}
proc MagickCLAHEImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cdouble,a5: cdouble): MagickBooleanType {.importc: "MagickCLAHEImage", header: headerMagickWand.}
...
proc MagickConstituteImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cstring,a5: StorageType): MagickBooleanType {.importc: "MagickConstituteImage", header: headerMagickWand.}
...
proc MagickCropImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickCropImage", header: headerMagickWand.}
...
proc MagickDistortImage*(a1: ptr MagickWand,a2: DistortMethod,a3: uint,a4: ptr cdouble,a5: MagickBooleanType): MagickBooleanType {.importc: "MagickDistortImage", header: headerMagickWand.}
...
proc MagickExportImagePixels*(a1: ptr MagickWand,a2: cint,a3: cint,a4: uint,a5: uint,a6: cstring,a7: StorageType): MagickBooleanType {.importc: "MagickExportImagePixels", header: headerMagickWand.}
proc MagickExtentImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickExtentImage", header: headerMagickWand.}
...
proc MagickFrameImage*(a1: ptr MagickWand,a2: ptr PixelWand,a3: uint,a4: uint,a5: cint,a6: cint,a7: CompositeOperator): MagickBooleanType {.importc: "MagickFrameImage", header: headerMagickWand.}
proc MagickFunctionImage*(a1: ptr MagickWand,a2: MagickFunction,a3: uint,a4: ptr cdouble): MagickBooleanType {.importc: "MagickFunctionImage", header: headerMagickWand.}
...
proc MagickGetImageColormapColor*(a1: ptr MagickWand,a2: uint,a3: ptr PixelWand): MagickBooleanType {.importc: "MagickGetImageColormapColor", header: headerMagickWand.}
...
proc MagickGetImagePage*(a1: ptr MagickWand,a2: ptr uint,a3: ptr uint,a4: ptr cint,a5: ptr cint): MagickBooleanType {.importc: "MagickGetImagePage", header: headerMagickWand.}
...
proc MagickImportImagePixels*(a1: ptr MagickWand,a2: cint,a3: cint,a4: uint,a5: uint,a6: cstring,a7: StorageType): MagickBooleanType {.importc: "MagickImportImagePixels", header: headerMagickWand.}
proc MagickInterpolativeResizeImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: PixelInterpolateMethod): MagickBooleanType {.importc: "MagickInterpolativeResizeImage", header: headerMagickWand.}
...
proc MagickLiquidRescaleImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cdouble,a5: cdouble): MagickBooleanType {.importc: "MagickLiquidRescaleImage", header: headerMagickWand.}
...
proc MagickNewImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: ptr PixelWand): MagickBooleanType {.importc: "MagickNewImage", header: headerMagickWand.}
...
proc MagickPingImageBlob*(a1: ptr MagickWand,a3: uint): MagickBooleanType {.importc: "MagickPingImageBlob", header: headerMagickWand.}
...
proc MagickPosterizeImage*(a1: ptr MagickWand,a2: uint,a3: DitherMethod): MagickBooleanType {.importc: "MagickPosterizeImage", header: headerMagickWand.}
proc MagickPreviousImage*(a1: ptr MagickWand): MagickBooleanType {.importc: "MagickPreviousImage", header: headerMagickWand.}
proc MagickQuantizeImage*(a1: ptr MagickWand,a2: uint,a3: ColorspaceType,a4: uint,a5: DitherMethod,a6: MagickBooleanType): MagickBooleanType {.importc: "MagickQuantizeImage", header: headerMagickWand.}
proc MagickQuantizeImages*(a1: ptr MagickWand,a2: uint,a3: ColorspaceType,a4: uint,a5: DitherMethod,a6: MagickBooleanType): MagickBooleanType {.importc: "MagickQuantizeImages", header: headerMagickWand.}
...
proc MagickRaiseImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint,a6: MagickBooleanType): MagickBooleanType {.importc: "MagickRaiseImage", header: headerMagickWand.}
...
proc MagickReadImageBlob*(a1: ptr MagickWand,a3: uint): MagickBooleanType {.importc: "MagickReadImageBlob", header: headerMagickWand.}
...
proc MagickResizeImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: FilterType): MagickBooleanType {.importc: "MagickResizeImage", header: headerMagickWand.}
...
proc MagickSampleImage*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickSampleImage", header: headerMagickWand.}
proc MagickScaleImage*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickScaleImage", header: headerMagickWand.}
...
proc MagickSetImageColormapColor*(a1: ptr MagickWand,a2: uint,a3: ptr PixelWand): MagickBooleanType {.importc: "MagickSetImageColormapColor", header: headerMagickWand.}
...
proc MagickSetImageDelay*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetImageDelay", header: headerMagickWand.}
proc MagickSetImageDepth*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetImageDepth", header: headerMagickWand.}
...
proc MagickSetImageCompressionQuality*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetImageCompressionQuality", header: headerMagickWand.}
...
proc MagickSetImageExtent*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickSetImageExtent", header: headerMagickWand.}
...
proc MagickSetImageIterations*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetImageIterations", header: headerMagickWand.}
...
proc MagickSetImagePage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickSetImagePage", header: headerMagickWand.}
...
proc MagickSetImageScene*(a1: ptr MagickWand,a2: uint): MagickBooleanType {.importc: "MagickSetImageScene", header: headerMagickWand.}
...
proc MagickShaveImage*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickShaveImage", header: headerMagickWand.}
...
proc MagickSparseColorImage*(a1: ptr MagickWand,a2: SparseColorMethod,a3: uint,a4: ptr cdouble): MagickBooleanType {.importc: "MagickSparseColorImage", header: headerMagickWand.}
proc MagickSpliceImage*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): MagickBooleanType {.importc: "MagickSpliceImage", header: headerMagickWand.}
...
proc MagickStatisticImage*(a1: ptr MagickWand,a2: StatisticType,a3: uint,a4: uint): MagickBooleanType {.importc: "MagickStatisticImage", header: headerMagickWand.}
...
proc MagickThumbnailImage*(a1: ptr MagickWand,a2: uint,a3: uint): MagickBooleanType {.importc: "MagickThumbnailImage", header: headerMagickWand.}
...
proc MagickSetImageProgressMonitor*(a1: ptr MagickWand,a2: MagickProgressMonitor): MagickProgressMonitor {.importc: "MagickSetImageProgressMonitor", header: headerMagickWand.}
...
proc MagickGetImageRegion*(a1: ptr MagickWand,a2: uint,a3: uint,a4: cint,a5: cint): ptr MagickWand {.importc: "MagickGetImageRegion", header: headerMagickWand.}
...
proc MagickMorphImages*(a1: ptr MagickWand,a2: uint): ptr MagickWand {.importc: "MagickMorphImages", header: headerMagickWand.}
...
proc MagickGetImageColors*(a1: ptr MagickWand): uint {.importc: "MagickGetImageColors", header: headerMagickWand.}
proc MagickGetImageCompressionQuality*(a1: ptr MagickWand): uint {.importc: "MagickGetImageCompressionQuality", header: headerMagickWand.}
proc MagickGetImageDelay*(a1: ptr MagickWand): uint {.importc: "MagickGetImageDelay", header: headerMagickWand.}
proc MagickGetImageDepth*(a1: ptr MagickWand): uint {.importc: "MagickGetImageDepth", header: headerMagickWand.}
proc MagickGetImageHeight*(a1: ptr MagickWand): uint {.importc: "MagickGetImageHeight", header: headerMagickWand.}
proc MagickGetImageIterations*(a1: ptr MagickWand): uint {.importc: "MagickGetImageIterations", header: headerMagickWand.}
proc MagickGetImageScene*(a1: ptr MagickWand): uint {.importc: "MagickGetImageScene", header: headerMagickWand.}
proc MagickGetImageTicksPerSecond*(a1: ptr MagickWand): uint {.importc: "MagickGetImageTicksPerSecond", header: headerMagickWand.}
proc MagickGetImageWidth*(a1: ptr MagickWand): uint {.importc: "MagickGetImageWidth", header: headerMagickWand.}
proc MagickGetNumberImages*(a1: ptr MagickWand): uint {.importc: "MagickGetNumberImages", header: headerMagickWand.}
proc MagickGetImageBlob*(a1: ptr MagickWand,a2: ptr uint): ptr cuchar {.importc: "MagickGetImageBlob", header: headerMagickWand.}
proc MagickGetImagesBlob*(a1: ptr MagickWand,a2: ptr uint): ptr cuchar {.importc: "MagickGetImagesBlob", header: headerMagickWand.}
...
proc NewPixelRegionIterator*(a1: ptr MagickWand,a2: cint,a3: cint,a4: uint,a5: uint): ptr PixelIterator {.importc: "NewPixelRegionIterator", header: headerMagickWand.}
...
proc SetWandViewThreads*(a1: ptr WandView,a2: uint) {.importc: "SetWandViewThreads", header: headerMagickWand.}
...
proc NewWandViewExtent*(a1: ptr MagickWand,a2: cint,a3: cint,a4: uint,a5: uint): ptr WandView {.importc: "NewWandViewExtent", header: headerMagickWand.}
...
proc MagickRelinquishMemory*[T](a1: T) {.importc: "MagickRelinquishMemory", header: headerMagickWand.}
